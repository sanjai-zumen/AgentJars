...
const connectiondetails =  db.user_connection_detail.find({orgId:"buy4adad087f601"}).forEach(function(conn){
   ...
   db.mappingstore.insert([{orgId:"buy4adad087f601",connectionId:x,zumenEndpoint:"/parts",httpOperation:"GET",outputField:"partReference",inputField:"oldMaterialNumber"}])
  ...
  db.mappingstore.insert([{orgId:"buy4adad087f601",connectionId:x,zumenEndpoint:"/parts/location",httpOperation:"GET",outputField:"partLocation",inputField:"plant"}])
   ...
   db.url_meta_data.insert({orgId:"buy4adad087f601",connectionId:x,zumenEndpoint:"/supplier",httpOperation:"GET",responseMetaData:sappartsschema})

   db.mappingstore.insert([{orgId:"buy4adad087f601",connectionId:x,zumenEndpoint:"/supplier",httpOperation:"GET",outputField:"supplierNumber",inputField:"vendorNumber"}])
   db.mappingstore.insert([{orgId:"buy4adad087f601",connectionId:x,zumenEndpoint:"/supplier",httpOperation:"GET",outputField:"supplierName",inputField:"vendorName"}])
   db.mappingstore.insert([{orgId:"buy4adad087f601",connectionId:x,zumenEndpoint:"/supplier",httpOperation:"GET",outputField:"supplierAddress",inputField:"address"}])
   db.mappingstore.insert([{orgId:"buy4adad087f601",connectionId:x,zumenEndpoint:"/supplier",httpOperation:"GET",outputField:"supplierEmail",inputField:"email"}])
   db.mappingstore.insert([{orgId:"buy4adad087f601",connectionId:x,zumenEndpoint:"/supplier",httpOperation:"GET",outputField:"supplierTaxNumber",inputField:"taxNumber"}])
